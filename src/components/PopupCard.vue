      ...
      <div :class="['popup-content', { show: isOpen }]" @click="closePopup">
        <div class="popup-header">
          <div class="popup-title">
            ...
            <h2 v-else-if="typeFlag === '3'">#3 프로젝트 관리 및 협업</h2>
            <h2 v-else-if="typeFlag === '4'">#4 세부 담당 업무</h2>
            <h2 v-else>EBS Oline Class 운영팀</h2>
          </div>
          <span class="popup-close" @click="closePopup"><i class="material-icons">close</i></span>
        </div>
        <div class="popup-body">
          <div class="popup-image">
            <a href="https://www.ebsoc.co.kr/" target="_blank">
              <img src="../assets/ebsoc_logo.png" class="img_ebs" alt="EBS 온라인클래스">
            </a>
          </div>
          <div class="popup-labels">
            ...
            <div v-else class="labels-container">
              ...
              <span class="label label-yellow">JavaScript</span>
              <span class="label label-orange">HTML</span>
              <span class="label label-pink">SCSS</span>
          ...
          <div class="popup-description mt25">
            ...
            <ul v-if="typeFlag === '1'" class="bull_list ml40 mr40">
              <li>Nuxt 기반의 Vue.js 프레임워크를 사용하여 EBS 온라인 클래스의 전반적인 프론트엔드 업무를 담당하였습니다.</li>
              <li>사용자 경험(UX) 및 사용자 인터페이스(UI) 최적화를 위해 최신 웹 기술을 활용한 인터페이스 설계 및 구현</li>
              <li>반응현 웹 디자인을 적용하여 다양한 디바이스 환경에서도 최적의 학습 경험을 제공</li>
              <li>웹 접근성 향상을 위한 표준 준수 및 최적화 작업 진행</li>
            </ul>
            <ul v-else-if="typeFlag === '2'" class="bull_list ml40 mr40">
              <li>서비스 안정성 및 성능 개선을 위한 지속적인 모니터링 및 버그 수정</li>
              <li>사용자 피드백을 반영하여 기능 개선 및 신규기능 추가</li>
              <li>백엔드 개발팀 및 디자이너와 협업하여 통합적이고 일관성 있는 서비스 제공</li>
            </ul>
            <ul v-else-if="typeFlag === '3'" class="bull_list ml40 mr40">
              <li>GitLab를 사용하여 소스 코드 버전 관리 및 협업</li>
              <li>SourceTree를 활용한 효율적인 형상 관리</li>
              <li>Trello를 활용하여 작업 항목을 체계적으로 관리하고 개발 진척 상황을 공유</li>
              <li>다양한 부서와의 협업을 통해 통합적인 서비스 제공 및 문제 해결</li>
            </ul>
            <ul v-else-if="typeFlag === '4'" class="bull_list ml40 mr40">
              <li>ISMS-P 소스코드 진단 조치 수행<br/>(초기 조치 후 진단조치 건수: 0건)</li>
              <li>TTA 사용자 편의성 점검 실시</li>
              <li>온라인 클래스 라이브 / 화상수업 초대 링크 공유 기능 개발</li>
              <li>화상수업 관리 페이지 (화상수업 등록, 수정, 수업정보 설정) 생성</li>
              <li>온라인 클래스 서비스 404 페이지 제작</li>
              <li>강의 상세 화면 푸리봇 연동(외부업체 협업)</li>
              <li>. . .</li>
            </ul>
            <ul v-else class="bull_list ml40 mr40">
              <li>전국 초⋅중⋅고 및 기타학교의 교사와 학생이 EBS 학습 콘텐츠를 활용하여 학교 수업을 대체할 수 있는 원격교육 서비스</li>
              <li>온라인 개학 학교 교육 플랫폼 운영팀의 일원으로, 국가 재난 상황에서 학습 공백방지와 학업성취도 제고를 위한 필수 서비스 제공에 기여하였습니다.</li>
            </ul>
          </div>
        </div>
        <!-- <div class="popup-footer">
          <button class="popup-button" @click="togglePopup">Close</button>
        </div> -->
      </div>
    </div>
</template>
...
.popup-body .popup-image .img_ebs{
  width: 50%;
  position: relative;
